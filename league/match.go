...
//GetMatchsByAccountID returns a match by an account ID
//
//https://developer.riotgames.com/apis#match-v4
func (svc *MatchService) GetMatchsByAccountID(encryptedAccountID string) (*MatchByAccountID, *Response, error) {
	// set the API endpoint path we send to the request
...
//
//https://developer.riotgames.com/apis#match-v4
func (svc *MatchService) GetMatchIDsOfTournament(tournamentCode string) (*MatchIDs, *Response, error) {
	// set the API endpoint path we send to the request
